...
const zonaFile = document.querySelector("[name=id_zona]");
const rolFile = document.querySelector("[name=id_rol]");
const estadoFile = document.querySelector("[name=id_estado]");
...
estadoFile.addEventListener("blur", (e) => validateEmptyField("Por favor, seleccione el estado", e));
